...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        howManyResults = Catalog.SearchCatalog(searchString, pageNumber,
                             productsOnPage, allWords)

        ' Do you have any results?
        If howManyResults = 0 Then
            titleLabel.Text = "Your search for <font color=red>" + searchString +
        ...
        Else
            titleLabel.Text = "Your search for <font color=red>" + searchString +
                      "</font> generated " + howManyResults.ToString +
                      " results:"
            ...
            Else
                previousLink.NavigateUrl =
                   ...
                   "?Search=" + searchString +
                   "&AllWords=" + allWords +
                   "&PageNumber=" + (CType(pageNumber, Integer) - 1).ToString +
